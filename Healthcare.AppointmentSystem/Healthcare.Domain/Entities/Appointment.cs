...
public sealed class Appointment : Entity
{
    ...
    /// Generated by the Singleton AppointmentCodeGenerator.
    /// </summary>
    /// <remarks>
    ...
    ///     Singleton service for generating unique reference codes.
    ///     If null, uses the global Singleton instance directly.
    ///     This allows the method to be called both via DI and in unit tests.
    /// </param>
    /// <returns>A new valid Appointment entity.</returns>
    /// <remarks>
    /// Design Patterns used here:
    ///   1. Factory Method  → static Create() controls instantiation
    ///   2. Singleton       → AppointmentCodeGenerator.Instance (one instance globally)
    ///   3. Guard Clauses   → fail-fast validation (Clean Code principle)
    /// </remarks>
