...
{
    private readonly ILogger<LogAppointmentCompletedHandler> _logger;
    private readonly IAuditLogRepository _auditLogRepo;
    private readonly IUnitOfWork _unitOfWork;

    public LogAppointmentCompletedHandler(
        ILogger<LogAppointmentCompletedHandler> logger,
        ...
        CancellationToken cancellationToken = default)
    {
        _logger.LogInformation(
            "[AUDIT] Appointment {AppointmentId} completed at {Timestamp} | " +
