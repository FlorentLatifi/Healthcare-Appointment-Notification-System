  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg px-4 sm:px-6 py-8">
      <div className="text-center max-w-sm w-full">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-text tracking-tight mb-2">403</h1>
        <p className="text-sm text-text-muted mb-8">
          You do not have permission to access this page.
        </p>
        <Button className="w-full sm:w-auto" rightIcon={<ArrowRight size={14} />} onClick={() => navigate('/dashboard')}>
          Go to Dashboard
        </Button>
      </div>
    </div>
